...
if fig == 1:
    ...
    # Tree
    tree_criterion = 'gini'
    tree_ccp_alpha = 0.005502093002093003
    min_samples_leaf = 9
    min_samples_split = 2
    # Adaboost
    boost_criterion = 'gini'
    boost_ccp_alpha = 0.0037037037037037034
    n_estimators = 30
    learning_rate = 0.9
    # KNN
    neighbors = 15
    ...
    ax.set_title("Fig 2.6.1 Accuracy vs Sample Size for Various Algorithms")
    ...
    ax.set_title("Fig 2.6.2 Training Time vs Sample Size for Various Algorithms")
    ...
    ax.set_title("Fig 2.6.3 Testing Time vs Sample Size for Various Algorithms")
    ax.plot(sample_size, tree_testing_scores, marker='s', label='Decision Tree')
    ax.plot(sample_size, adaboost_testing_scores, marker='s', label='Adaboost')
    ax.plot(sample_size, knn_testing_scores, marker='s', label='KNN')
