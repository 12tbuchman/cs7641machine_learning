...
"""
poly
{'C': 1.0, 'coef0': 0.15, 'degree': 2, 'tol': 0.0005}
0.538888888888889
rbf
{'C': 1.0, 'tol': 0.0005}
0.5222222222222223
...
if fig == 1:
    ...
    ax.set_title("Fig 2.5.1a Accuracy vs Sample Size for Polynomial Kernel")
    ...
    ax.set_xlabel("Sample Size")
    ax.set_ylabel("Accuracy")
    ax.set_title("Fig 2.5.1b Test Scores Accuracy vs Sample Size for Polynomial Kernel")
...
if fig == 2:
    ...
    validation_scores = []
    testing_scores = []
    data, grades = sample_balanced_dataset(samples=6000)
    data_train, data_test, labels_train, labels_test = train_test_split(data, grades,
                                                                        test_size=TEST_SIZE,
                                                                        random_state=RANDOM_STATE)
    max_iterations = [i * 100 for i in range(1, 11)]
    ...
    ax.set_ylabel("Accuracy")
    ax.set_title("Fig 2.5.2 Accuracy vs Max Iterations for Polynomial Kernel")
...
if fig == 3:
    ...
    ax.set_xlabel("Sample Size")
    ax.set_ylabel("Accuracy")
    ax.set_title("Fig 2.5.3a Accuracy vs Sample Size for RBF Kernel")
    ax.plot(sample_size, training_scores, marker='s', label='Training Scores')
    ax.plot(sample_size, validation_scores, marker='s', label='Validation Scores')
    ax.plot(sample_size, cv_testing_scores, marker='s', label='Test Scores')
    plt.legend()
    ...
    ax.set_xlabel("Sample Size")
    ax.set_ylabel("Accuracy")
    ax.set_title("Fig 2.5.3b Test Scores Accuracy vs Sample Size for RBF Kernel")
    ax.plot(sample_size, testing_scores, marker='s', label='With Cross Validation')
    ax.plot(sample_size, cv_testing_scores, marker='s', label='Without Cross Validation')
    plt.legend()
    plt.show()
...
if fig == 4:
    ...
    ax.set_xlabel("Max Iterations")
    ax.set_ylabel("Accuracy")
    ax.set_title("Fig 2.5.4 Accuracy vs Max Iterations for RBF Kernel")
    ax.plot(max_iterations, training_scores, marker='s', label='Training Scores')
    ax.plot(max_iterations, validation_scores, marker='s', label='Validation Scores')
    ax.plot(max_iterations, testing_scores, marker='s', label='Test Scores')
    plt.legend()
...
if fig == 5:
    ...
    ax.set_xlabel("Sample Size")
    ax.set_ylabel("Accuracy")
    ax.set_title("Fig 2.5.5a Accuracy vs Sample Size for Linear Kernel")
    ax.plot(sample_size, training_scores, marker='s', label='Training Scores')
    ax.plot(sample_size, validation_scores, marker='s', label='Validation Scores')
    ax.plot(sample_size, cv_testing_scores, marker='s', label='Test Scores')
    plt.legend()
    ...
    ax.set_xlabel("Sample Size")
    ax.set_ylabel("Accuracy")
    ax.set_title("Fig 2.5.5b Test Scores Accuracy vs Sample Size for Linear Kernel")
    ax.plot(sample_size, testing_scores, marker='s', label='With Cross Validation')
    ax.plot(sample_size, cv_testing_scores, marker='s', label='Without Cross Validation')
    plt.legend()
    plt.show()
...
if fig == 6:
    ...
    ax.set_xlabel("Max Iterations")
    ax.set_ylabel("Accuracy")
    ax.set_title("Fig 2.5.6 Accuracy vs Max Iterations for Linear Kernel")
    ax.plot(max_iterations, training_scores, marker='s', label='Training Scores')
    ax.plot(max_iterations, validation_scores, marker='s', label='Validation Scores')
    ax.plot(max_iterations, testing_scores, marker='s', label='Test Scores')
    plt.legend()
